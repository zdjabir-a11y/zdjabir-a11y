...
* 🏗️ Expérience dans le développement d'**applications d'entreprise et d'applications destinées aux clients**.

* 🚀 Passionné par le **code propre, l'architecture des systèmes et la résolution de problèmes réels**.

* 📄 **CV :** Disponible sur demande ou via LinkedIn

  ### 🤔 Vous pouvez me poser des questions sur :

* La conception et le développement d'**API Backend** avec **.NET Core et FastAPI**.

* Le développement de **systèmes basés sur l'IA et d'agents intelligents** avec **LangChain et RAG**.

* L'utilisation de **PostgreSQL, SQL Server et MongoDB** dans des applications réelles.

* La création et la maintenance de **systèmes Full-Stack avec une forte orientation Backend**.

<!--
  ### 🌱 Ce que j'apprends actuellement

- Développement d'applications responsives avec le *MERN Stack*.
- *Algorithmes avancés d'IA/ML* pour améliorer la précision prédictive.
- Exploration du *traitement des données en temps réel* avec *Socket.io* et *WebSockets*.
-->
...
|---|---|
| **💻 Langages de programmation** | Python, JavaScript, TypeScript, C, C++ |
| **🌐 Développement Web** | React, Node.js, Express.js, Bootstrap, Tailwind CSS, HTML, CSS |
| **🛠 Bases de données et outils** | MongoDB, PostgreSQL, MySQL, Firebase, Postman, Git, GitHub |
| **🔍 IA/ML & Science des données** | Scikit-Learn, Numpy, Pandas, Matplotlib, NLTK |
| **🚀 Déploiement & DevOps** | Render, Vercel, Netlify |
